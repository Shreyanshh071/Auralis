...
/**
 * High-precision AMLL RichSync TTML XML parser extracting per-word millisecond timestamps
 * for syllable-level karaoke synchronized lyrics.
 */
object TtmlParser {

    /**
     * Parses TTML XML markup into domain [LyricsData] with word-level timing precision.
     */
    fun parse(ttmlXml: String, provider: LyricsProvider = LyricsProvider.AMLL): LyricsData {
        ...
        try {
            ...
            // Gracefully return collected lines
        }
    ...
    /**
     * Converts varied TTML timestamp formats (e.g. "01:23.456", "83.45s", "83450ms") to milliseconds.
     */

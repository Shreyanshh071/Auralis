...
class AutoPlayInfiniteRadioTest {
    ...
    private class MockInnerTubeClient(
        ...
        override suspend fun getRadioTracks(videoId: String): List<Track> {
    ...
    private class MockLibraryRepo : LibraryRepository {
        ...
        override suspend fun createPlaylist(title: String, description: String?): Playlist = Playlist(id = "1", title = title)
